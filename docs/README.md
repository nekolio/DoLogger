...
| [KV and SIF Migration](en_US/guides/KvWireAndSifMigration.md) | KVF1 runtime framing, retained SIF compatibility, and migration rules. |
...
| [KV 与 SIF 迁移](zh_CN/guides/KvWireAndSifMigration.md) | KVF1 运行帧、SIF 兼容读取与迁移规则 |
